<div class="container mt-5" wire:poll.5000ms="refreshPrices">
    <div class="d-flex gap-3">
        <div class="col-md-4 border p-4" style="height: 500px;">
            ...
            <div class="mb-2">
                ...
                <input type="number" step="1" id="change_percent" class="form-control rounded-0" wire:model.live.debounce.200ms="change_percent">
    ...
    <button class="btn btn-primary rounded-0 mt-3" wire:click="saveProduct">Zapisz</button>
</div>
